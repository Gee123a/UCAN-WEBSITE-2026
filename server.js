...
var ADMIN_EXPORT_USER = process.env.ADMIN_EXPORT_USER;
var ADMIN_EXPORT_PASSWORD = process.env.ADMIN_EXPORT_PASSWORD;
app.use(cors());
app.use(express.json());
function isValidCiputraEmail(email) {
...
function isAuthorizedAdminRequest(authHeader) {
...
async function addEventToCalendar(token) {
  try {
