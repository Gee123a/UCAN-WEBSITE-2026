...
const dresscodeModules = import.meta.glob('./assets/Dresscode/*.{png,PNG,jpeg,JPEG,jpg,JPG,webp,WEBP}', { eager: true });
...
export default function UCANWebsite() {
  ...
  const dresscodeIntervalRef = useRef<NodeJS.Timeout | null>(null);

  const startDresscodeRotation = () => {
    if (dresscodeIntervalRef.current) {
      clearInterval(dresscodeIntervalRef.current);
    }
    dresscodeIntervalRef.current = setInterval(() => {
  ...
  const handlePrevDresscode = (e: React.MouseEvent) => {
    e.stopPropagation();
    setCurrentDresscodeIndex((prev) => (prev - 1 + dresscodeImages.length) % dresscodeImages.length);
    startDresscodeRotation();
  };

  const handleNextDresscode = (e: React.MouseEvent) => {
    e.stopPropagation();
    setCurrentDresscodeIndex((prev) => (prev + 1) % dresscodeImages.length);
    startDresscodeRotation();
  };
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <motion.div
                  ...
                  className="lg:col-span-4 storybook-card group cursor-pointer rotate-[0.5deg] border-[#D96A1D] border-dashed overflow-hidden relative min-h-[550px] flex flex-col justify-end"
                >
                  ...
                  <button
                    onClick={handlePrevDresscode}
                    className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-[#FFFDF9]/90 border border-[#D96A1D]/40 text-[#D96A1D] hover:bg-[#D96A1D] hover:text-white transition-all duration-300 flex items-center justify-center shadow-md hover:scale-105 active:scale-95"
                    aria-label="Previous dresscode image"
                  >
                    <ChevronLeft className="w-6 h-6" />
                  </button>
                  <button
                    onClick={handleNextDresscode}
                    className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-[#FFFDF9]/90 border border-[#D96A1D]/40 text-[#D96A1D] hover:bg-[#D96A1D] hover:text-white transition-all duration-300 flex items-center justify-center shadow-md hover:scale-105 active:scale-95"
                    aria-label="Next dresscode image"
                  >
                    <ChevronRight className="w-6 h-6" />
                  </button>

                  <div className="relative z-10 flex-1 flex flex-col justify-end pt-20">
                    <div className="mb-4">
                    ...
                    <p className="font-montserrat text-sm text-[#4C7A1A]">
                      Dress with your most royal attire in navy, baby blue, red, yellow, or brown.
                    </p>
                  </div>
                ...
                <motion.div
                  ...
                  className="lg:col-span-4 storybook-card group cursor-pointer -rotate-[0.4deg] border-[#F08A2B] border-dashed min-h-[550px] flex flex-col justify-end"
                >
                  <div className="absolute inset-0">
                    <ImageWithFallback
                      src={Performance}
                ...
                <motion.div
                  ...
                  className="lg:col-span-4 storybook-card rotate-[0.3deg] border-[#C93A1D] border-dashed min-h-[550px] flex flex-col justify-between"
                >
                  <div className="w-16 h-16 rounded-full flex items-center justify-center bg-[#C93A1D]/10 border-[3px] border-dotted border-[#C93A1D]">
